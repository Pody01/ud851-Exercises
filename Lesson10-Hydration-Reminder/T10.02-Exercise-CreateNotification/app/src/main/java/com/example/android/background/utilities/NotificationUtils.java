...
public class NotificationUtils {
    ...
    private static final int PENDING_INTENT_ID = 334;
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "water_reminder_not_channel_id";
    ...
    public static void remindUserBecauseChargint(Context context) {
        ...
        notificationManager.notify(PENDING_INTENT_ID, builder.build());
    }
